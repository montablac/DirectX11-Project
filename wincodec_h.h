...
EXTERN_C const IID IID_IWICProgressiveLevelControl;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE GetLevelCount( 
            /* [retval][out] */ UINT *pcLevels) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE GetCurrentLevel( 
            /* [retval][out] */ UINT *pnLevel) = 0;
...
EXTERN_C const IID IID_IWICPixelFormatInfo2;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE SupportsTransparency( 
            /* [out] */ BOOL *pfSupportsTransparency) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE GetNumericRepresentation( 
            /* [out] */ WICPixelFormatNumericRepresentation *pNumericRepresentation) = 0;
...
EXTERN_C const IID IID_IWICDevelopRaw;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE SetDestinationColorContext( 
            /* [unique][in] */ IWICColorContext *pColorContext) = 0;
        ...
        virtual HRESULT STDMETHODCALLTYPE SetNotificationCallback( 
            /* [unique][in] */ IWICDevelopRawNotificationCallback *pCallback) = 0;
...
EXTERN_C const IID IID_IWICDdsDecoder;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE GetParameters( 
            /* [out] */ WICDdsParameters *pParameters) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE GetFrame( 
            /* [in] */ UINT arrayIndex,
            /* [in] */ UINT mipLevel,
            /* [in] */ UINT sliceIndex,
            /* [retval][out] */ IWICBitmapFrameDecode **ppIBitmapFrame) = 0;
...
EXTERN_C const IID IID_IWICDdsEncoder;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE SetParameters( 
            /* [in] */ WICDdsParameters *pParameters) = 0;
        ...
        virtual HRESULT STDMETHODCALLTYPE CreateNewFrame( 
            ...
            /* [optional][out] */ UINT *pSliceIndex) = 0;
...
EXTERN_C const IID IID_IWICDdsFrameDecode;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE GetSizeInBlocks( 
            ...
            /* [out] */ UINT *pHeightInBlocks) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE GetFormatInfo( 
            /* [out] */ WICDdsFormatInfo *pFormatInfo) = 0;
...
unsigned long             __RPC_USER  WICInProcPointer_UserSize(     unsigned long *, unsigned long            , WICInProcPointer * ); 
unsigned char * __RPC_USER  WICInProcPointer_UserMarshal(  unsigned long *, unsigned char *, WICInProcPointer * ); 
unsigned char * __RPC_USER  WICInProcPointer_UserUnmarshal(unsigned long *, unsigned char *, WICInProcPointer * ); 
void                      __RPC_USER  WICInProcPointer_UserFree(     unsigned long *, WICInProcPointer * ); 
